...
//    	$pr = "lg";//工号前缀
    ...
    public function getUserinfoByUid($uid){
    	$sql = "select uid,username,mobile,address from userlist where uid='$uid'";
    	$query = $this->db->query($sql);
    	$arr = $query->row_array();
    	if($arr){
    		return $arr;
...
//				var_dump($temp);var_dump($return_info);exit;
    ...
    public function getCoUserInfo($uid){
    	$sql = "select pro_t.name as province,city_t.name as city, user_co.coname, co_scale.name as scale,
				userlist.mobile,userlist.wechat,userlist.qq,user_co.info,userlist.is_real,user_co.idno
    ...
    public function getPersonalInfo($uid){
    	$sql = "select pro_t.name as province,city_t.name as city,user_personal.realname,user_personal.sex,
				userlist.mobile,userlist.wechat,userlist.qq,user_personal.info,userlist.is_real,user_personal.idno
