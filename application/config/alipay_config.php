...
$alipay_config['partner']		= '2016071801635130';
...
$alipay_config['notify_url'] = "http://". $_SERVER['HTTP_HOST'] ."/pay/notify_url";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] = "http://". $_SERVER['HTTP_HOST'] ."/pay/return_url";
...
$alipay_config['cacert']    = APPPATH.'libraries/alipay_pc/cacert.pem';
